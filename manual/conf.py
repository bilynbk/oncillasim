...
#source_encoding = 'utf-8-sig'    # The encoding of source files.

# General information about the project.
project = 'oncilla-sim'
release = '0.2.0~rc1'              # The full version
version = '0.2'                    # The short X.Y version.
copyright = u'2012, Arne Nordmann, Alexandre Tuleu'
language  = 'en'                        # Language for autogenerated
                                        # content
...
.. _cppcheck: http://sourceforge.net/apps/mediawiki/cppcheck/index.php?title=Main_Page
...
html_sidebars = {
    '**': [ 'globaltoc.html', 'links.html', 'sourcelink.html', 'searchbox.html' ]
}
...
htmlhelp_basename = 'oncilla-sim-manual'
...
latex_documents = [
    ('index', 'oncilla-sim-manual.tex', u'Oncilla-Sim Manual', u'Arne Nordmann, Alexandre Tuleu', 'manual'),
    ]
...
man_pages = [
    ('info',   'info',   u'info Program',   [u'Jan Moringen'], 1),
    ('logger', 'logger', u'logger Program', [u'Jan Moringen'], 1),
    ('send',   'send',   u'send Progam',    [u'Jan Moringen'], 1),
    ('call',   'call',   u'call Progam',    [u'Jan Moringen'], 1)
    ]
